<?php
  $currentStatus = old('status', $log['status']);
  $currentDowntime = old('has_downtime', $log['has_downtime']);
...
<style>
  ...
  .ticket-edit-page .edit-head {
    padding: 14px 18px;
    border-bottom: 1px solid var(--te-border);
    background: linear-gradient(180deg, #ffffff 0%, #fbfdff 100%);
  }
  .ticket-edit-page .edit-body {
    padding: 18px;
  }
  .ticket-edit-page .edit-title {
    margin: 0;
    font-size: 1.08rem;
    font-weight: 700;
    color: var(--te-text);
  }
  .ticket-edit-page .meta-text {
    font-size: 12px;
    color: var(--te-muted);
  }
  .ticket-edit-page .section {
    border: 1px solid var(--te-border);
    border-radius: 12px;
    padding: 14px;
  ...
  .ticket-edit-page .section-title {
    font-size: 12px;
  ...
  .ticket-edit-page .form-control,
  .ticket-edit-page .form-control-file {
    border-radius: 10px;
    border-color: #dbe3ec;
    min-height: 42px;
  }
  .ticket-edit-page textarea.form-control {
    min-height: 110px;
  }
  .ticket-edit-page .btn {
    border-radius: 10px;
  }
  .ticket-edit-page .actions {
    display: flex;
  ...
  @media (max-width: 991.98px) {
    ...
    .ticket-edit-page .actions .btn {
      width: 100%;
    }
  }
</style>

<div class="row ticket-edit-page">
  <div class="col-12 col-lg-10 offset-lg-1">
    <div class="edit-card">
      <div class="edit-head">
        <div class="d-flex align-items-center justify-content-between flex-wrap">
          <div>
            <h2 class="edit-title">Edit Ticket #<?= $log['id'] ?></h2>
            <div class="meta-text mt-1">Perbarui data ticket dengan struktur yang lebih rapi dan konsisten.</div>
          </div>
          <span class="badge <?= $statusTone ?> mt-2 mt-md-0"><?= esc($currentStatus) ?></span>
        </div>
      </div>
        ...
        <form action="<?= base_url('maintenance-logs/update/' . $log['id']) ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="section">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <label for="maintenance_date">Tanggal & Waktu Ticket <span class="text-danger">*</span></label>
          ...
          <div class="section">
            <div class="section-title">Analisis Dan Tindakan</div>
            <div class="form-group">
          ...
          <div class="section">
            <div class="section-title">Status Dan Dampak</div>
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
          ...
          <div class="section">
            ...
            <?php endif; ?>
            <input type="file" class="form-control-file" id="attachment" name="attachment" accept=".jpg,.jpeg,.png,.gif,.pdf,.log,.txt,.zip">
            <small class="form-text text-muted">Kosongkan jika tidak ingin mengubah attachment.</small>
          </div>

          <div class="actions">
            <a href="<?= base_url('maintenance-logs') ?>" class="btn btn-light border">Batal</a>
